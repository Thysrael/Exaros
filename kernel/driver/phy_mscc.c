...
i32 vsc8541_config(u32 phydev_addr, PhyInterfaceMode interface)
{
    ...
    default: {
        NET_DEBUG("PHY 8541 MAC i/f config Error: mac i/f = {%u}\n", interface);
        return -22;
    }
    }
...
i32 mscc_phy_soft_reset(u32 phydev_addr)
{
    ...
    if (timeout == 0)
    {
        ...
        NET_DEBUG("MSCC PHY Soft_Reset Error\n");
        return -1;
    }
    return 0;
}
...
{
    NET_DEBUG("mscc_vsc8531_vsc8541_init_scripts\n");
...
i32 vsc8531_vsc8541_mac_config(u32 phydev_addr, PhyInterfaceMode interface)
{
    ...
    default: {
        NET_DEBUG("MSCC PHY - INVALID MAC i/f Config: mac i/f = {%u}\n", interface);
        return -1;
    }
    }
    ...
    NET_DEBUG("vsc8531_vsc8541_mac_config reg_val: {%u}\n", reg_val);
...
i32 vsc8531_vsc8541_clk_skew_config(u32 phydev_addr, PhyInterfaceMode interface)
{
    ...
    */
    ...
    NET_DEBUG("vsc8531_vsc8541_clk_skew_config reg_val: {:%u}\n", reg_val);
    macb_mdio_write(phydev_addr, MSCC_PHY_RGMII_CNTL_REG, reg_val);
    macb_mdio_write(phydev_addr, MSCC_EXT_PAGE_ACCESS, MSCC_PHY_PAGE_STD);
    return 0;
}
...
i32 vsc8531_vsc8541_clkout_config(u32 phydev_addr)
{
    ...
    default: {
        NET_DEBUG("PHY 8530/31 invalid clkout rate {%u}\n", clkout_rate);
        return -1;
    }
    }

    NET_DEBUG("vsc8531_vsc8541_clkout_config reg_val: {%u}\n", reg_val);
...
i32 genphy_setup_forced(u32 phydev_addr, i32 speed, i32 duplex)
{
    ...
    NET_DEBUG("genphy_setup_forced Write MII_BMCR: {%u}\n", ctl);
    ...
    u32 phydev_supported)
{
    ...
    */
    ...
    NET_DEBUG("genphy_config_advert Write MII_CTRL1000: {%u}\n", adv);
...
i32 genphy_restart_aneg(u32 phydev_addr)
{
    ...
    NET_DEBUG("genphy_restart_aneg MII_BMCR: {%u}\n", ctl);
    macb_mdio_write(phydev_addr, MII_BMCR, ctl);
    return 0;
}